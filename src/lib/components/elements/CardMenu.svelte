	...
	.__card-wrapper {
		...
		.__card-content {
			...
			.__card-title {
				@apply flex flex-col;
				h1 {
					@apply text-dark-300 text-[1.3rem] font-semibold leading-snug;
				}
			}
			...
			.__label {
				...
				p {
					@apply text-light-100 bg-primary-100 rounded-full px-2 text-[0.8rem] font-normal;
				}
			}
			...
			.__card-footer {
				...
				.__rating {
					...
					p {
						@apply text-dark-400 text-[1rem] font-semibold;
					}
				}
				h1 {
